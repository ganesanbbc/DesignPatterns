 ...
 */
public class ExpandableRecycleViewFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        textView.setText("ExpandableRecycleViewFragment");
    ...
    private void loadData(List<ExpandableListAdapter.Item> data) {
    ...
    public static ExpandableRecycleViewFragment getInstance() {
        return new ExpandableRecycleViewFragment();
    }
